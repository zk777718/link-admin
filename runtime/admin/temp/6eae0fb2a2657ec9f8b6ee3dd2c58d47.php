<?php /*a:4:{s:41:"/var/www/html/view/admin/imBg/detail.html";i:1684251969;s:35:"../view/admin/common/cssHeader.html";i:1684251969;s:33:"../view/admin/common/confirm.html";i:1684251969;s:34:"../view/admin/common/jsHeader.html";i:1684251969;}*/ ?>
<!DOCTYPE html>
<html>
                                ...
                                <table id="data_table" style="width:100%;">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center"><img src="<?php echo htmlentities($item['image_url']); ?>" width="50px" class="show_img" alt=""></td>
    ...
    <script>
        function edit(obj) {
            ...
            $(".edit-append").prepend(
                ...
                "<input type='hidden' value='/admin/imBgSave' id='master_url' name='master_url'>" +
                "</form>"
            );
        ...
        $('.add').on('click', function () {
            ...
            $(".add-append").prepend(
                ...
                "<input type='hidden' value='<?php echo htmlentities($token); ?>' name='token'>" +
                "<input type='hidden' value='/admin/imBgAdd' id='master_url' name='master_url'>" +
                " </form>"
            );
            $('#addModal').modal('show');
        });
        ...
        $("#online").click(function () {
            $.ajax({
                async: false, //表示请求是否异步处理
                type: "post", //请求类型
                url: "/admin/imBgOnline", //请求的 URL地址
                token: $("#token").val(),
                dataType: "json", //返回的数据类型
                data: {
                    token: $('#token').val(),
                    master_url: '/admin/imBgOnline'
                },
                success: function (rs) {
                    if (rs.code != 200) {
                        toastr.warning(rs.desc);
